...
def intervalo_horas_5(hora_inicio, hora_final, periocidades, data_inicio):
    data = []
    data2 = []
...
def intervalo_dias_5(data_inicio, data_final, periocidades):
    data = []
    data2 = []
    label = []
    dateStart = datetime.strptime(data_inicio,"%Y-%m-%d").date()
...
def intervalo_meses_5(data_inicio, data_final, periocidades):
    data=[]
    data2 = []
    label=[]
    dateStart = datetime.strptime(data_inicio,"%Y-%m-%d").date()
...
def intervalo_anos_5(data_inicio, data_final, periocidades):
    data=[]
    data2=[]
    label=[]
    dateStart = datetime.strptime(data_inicio,"%Y-%m-%d").date()
...
def intervaloTempo_5(data_inicio, hora_inicio, data_final, hora_final, periocidades):
    dateStart = datetime.strptime(data_inicio,"%Y-%m-%d").date()
    dateEnd = datetime.strptime(data_final,"%Y-%m-%d").date()
    d = dateEnd - dateStart
    if (d.days < 1): #ver em intervalo de horas
        return intervalo_horas_5(hora_inicio, hora_final, periocidades, data_inicio)
    elif (d.days <= 31): #ver em intervalo de dias
        return intervalo_dias_5(data_inicio, data_final, periocidades)
    elif (d.days<=365): #ver em intervalo de meses
        return intervalo_meses_5(data_inicio, data_final, periocidades)
    else: #ver em anos
        return intervalo_anos_5(data_inicio, data_final, periocidades)
