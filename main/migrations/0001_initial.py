# Generated by Django 4.0.6 on 2022-07-09 23:28
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(db_column='ID', primary_key=True, serialize=False)),
                ('registration', models.CharField(db_column='Registration', max_length=8, verbose_name='Registration')),
                ('foreign', models.BooleanField(db_column='Is Foreign', verbose_name='Is Foreign')),
                ('brand', models.CharField(db_column='Brand', max_length=20, verbose_name='Brand')),
                ('model', models.CharField(db_column='Model', max_length=20, verbose_name='Model')),
                ('deleted', models.BooleanField(db_column='Deleted', default=False, verbose_name='Is Deleted')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(db_column='ID', primary_key=True, serialize=False)),
                ('valorcontrato', models.FloatField(blank=True, db_column='ValorContrato', null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_open', models.BooleanField(db_column='IsOpen', default=True, verbose_name='Open')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('x', models.IntegerField(db_column='Abscissa', verbose_name='Abscissa')),
                ('y', models.IntegerField(db_column='Ordiante', verbose_name='Ordiante')),
                ('direction', models.CharField(choices=[('VE', 'Vertical'), ('HO', 'Horizontal')], db_column='Direction', max_length=2, verbose_name='Direction')),
                ('is_archived', models.BooleanField(db_column='IsArchived', default=False, verbose_name='Archived')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(db_column='ID', primary_key=True, serialize=False)),
                ('archived', models.BooleanField(db_column='Archived', default=False, verbose_name='Archived')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('criadoem', models.DateTimeField(db_column='CriadoEm', default=django.utils.timezone.now)),
                ('editadoem', models.DateTimeField(db_column='EditadoEm', default=django.utils.timezone.now)),
                ('lugarid', models.ForeignKey(db_column='LugarID', on_delete=django.db.models.deletion.DO_NOTHING, to='main.parkingspot')),
                ('matricula', models.ForeignKey(db_column='matricula', on_delete=django.db.models.deletion.DO_NOTHING, to='main.car')),
                ('periocidadeid', models.ForeignKey(db_column='PeriocidadeID', on_delete=django.db.models.deletion.DO_NOTHING, to='main.periocidade')),
            ],
            options={
                'db_table': 'Visit',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(db_column='ID', primary_key=True, serialize=False)),
                ('matricula', models.CharField(db_column='Matricula', max_length=8, verbose_name='Matricula')),
                ...
                ('estadoreservaid', models.ForeignKey(db_column='EstadoReservaID', default=1, on_delete=django.db.models.deletion.CASCADE, to='main.estadoreserva')),
                ('lugarid', models.ForeignKey(db_column='LugarID', on_delete=django.db.models.deletion.CASCADE, to='main.parkingspot')),
                ('parqueid', models.ForeignKey(blank=True, db_column='ParqueID', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='main.park')),
                ...
                ('userid', models.ForeignKey(db_column='UserID', on_delete=django.db.models.deletion.CASCADE, to='main.client')),
            ],
            options={
                'db_table': 'Reserva',
            },
        ...
        migrations.AddField(
            model_name='entradassaidas',
            name='tipo',
            field=models.ForeignKey(db_column='EstadoRecursoID', on_delete=django.db.models.deletion.CASCADE, to='main.estadorecurso'),
        ),
        migrations.AddField(
            model_name='contrato',
        ...
        migrations.AddField(
            model_name='contrato',
            name='matricula',
            field=models.ForeignKey(db_column='matricula', null=True, on_delete=django.db.models.deletion.CASCADE, to='main.car'),
        ),
        migrations.AddField(
            model_name='contrato',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('NO', 'Normal'), ('FI', 'Fine')], db_column='Type', max_length=2, verbose_name='Type')),
                ('table', models.ForeignKey(db_column='PriceTable', on_delete=django.db.models.deletion.CASCADE, to='main.pricetable', verbose_name='Price Table')),
            ],
            options={
                'db_table': 'PriceType',
