...
urlpatterns = [
    ...
    path('account/<pk>/', views.ViewAccountDetail.as_view(), name='account'),
    ...
    path('account/<pk>/employees/', views.ViewEmployeeList.as_view(), name='employees'),
    path('account/<pk>/roles/', views.ViewRoleRequestList.as_view(), name='roles'),
]
